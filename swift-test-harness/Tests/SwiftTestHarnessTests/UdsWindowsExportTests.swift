...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `UdsWindows.swiftmodule/`
...
//      `import UdsWindows` above would fail at compile time.
//
//   2. The static archive `libUdsWindows.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "UdsWindows" }` and
//      `flattenPackage = "io.github.kotlinmania.udswindows"` configuration in
...
//      via the `UdsWindowsLibrary` product.
//
