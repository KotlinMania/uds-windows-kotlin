...
kotlin {
    ...
    val xcf = XCFramework("UdsWindows")
    ...
    swiftExport {
        moduleName = "UdsWindows"
        flattenPackage = "io.github.kotlinmania.udswindows"
    }

    android {
        namespace = "io.github.kotlinmania.udswindows"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "uds-windows-kotlin", version.toString())

    pom {
        name.set("uds-windows-kotlin")
        description.set("Kotlin Multiplatform port of haraldh/rust_uds_windows - Unix Domain Sockets for Windows!")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/uds-windows-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/uds-windows-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/uds-windows-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/uds-windows-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleUdsWindowsXCFramework",
    "assembleUdsWindowsDebugXCFramework",
    "assembleUdsWindowsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseIosFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugMacosFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseMacosFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugTvosFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseTvosFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugWatchosFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseWatchosFatFrameworkForUdsWindowsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForUdsWindowsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForUdsWindowsXCFramework",
