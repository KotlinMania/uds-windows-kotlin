...
This file is the quick-reference operating contract for uds-windows-kotlin. The longer
...
uds-windows-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`uds_windows`](https://crates.io/crates/uds_windows). Upstream Rust is the behavioral oracle while the
